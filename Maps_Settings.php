...
// Mapping services configuration
	...
	$mapsDefaultSettings['egMapsAvailableServices'] = [
		'leaflet',
		'openlayers',
		'googlemaps3'
	];
	...
	$mapsDefaultSettings['egMapsDefaultService'] = 'leaflet';
	...
	$mapsDefaultSettings['egMapsDefaultServices'] = [];
	$mapsDefaultSettings['egMapsDefaultServices']['display_map'] = $mapsDefaultSettings['egMapsDefaultService'];
	$mapsDefaultSettings['egMapsDefaultServices']['qp'] = $mapsDefaultSettings['egMapsDefaultService'];
...
// Enable/disable parts of the extension
        ...
        $mapsDefaultSettings['egMapsDisableExtension'] = false;

        // Allows disabling the Semantic MediaWiki integration.
        $mapsDefaultSettings['egMapsDisableSmwIntegration'] = false;
...
// Geocoding
	...
	$mapsDefaultSettings['egMapsDefaultGeoService'] = 'nominatim';
...
// Coordinate configuration
	...
	$mapsDefaultSettings['egMapsCoordinateNotation'] = Maps_COORDS_DMS;

	# Enum. The default output format of coordinates when displayed by Semantic MediaWiki.
	# Possible values: Maps_COORDS_FLOAT, Maps_COORDS_DMS, Maps_COORDS_DM, Maps_COORDS_DD
	$mapsDefaultSettings['smgQPCoodFormat'] = $mapsDefaultSettings['egMapsCoordinateNotation'];
	...
	$mapsDefaultSettings['egMapsCoordinateDirectional'] = true;
	...
	$mapsDefaultSettings['smgQPCoodDirectional'] = $mapsDefaultSettings['egMapsCoordinateDirectional'];

	// Boolean. Sets if direction labels should be translated to their equivalent in the wiki language or not.
	$mapsDefaultSettings['egMapsInternatDirectionLabels'] = true;
...
// Distance configuration
	...
	$mapsDefaultSettings['egMapsDistanceUnits'] = [
		'm' => 1,
		'meter' => 1,
		'meters' => 1,
		'km' => 1000,
	...
	$mapsDefaultSettings['egMapsDistanceUnit'] = 'm';

	// Integer. The default amount of fractal digits in a distance.
	$mapsDefaultSettings['egMapsDistanceDecimals'] = 2;
...
// General map configuration
	...
	$mapsDefaultSettings['egMapsMapWidth'] = 'auto';
	$mapsDefaultSettings['egMapsMapHeight'] = 350;
	...
	// allowed value.
	$mapsDefaultSettings['egMapsSizeRestrictions'] = [
		'width'  => [ 50, 1020, 1, 100 ],
		'height' => [ 50, 1000, 1, 100 ],
	];

	// String. The default centre for maps. Can be either a set of coordinates or an address.
	$mapsDefaultSettings['egMapsDefaultMapCentre'] = '0, 0';

	// Strings. The default content for all pop-ups. This value will only be used
	// when the user does not provide one.
	$mapsDefaultSettings['egMapsDefaultTitle'] = '';
	$mapsDefaultSettings['egMapsDefaultLabel'] = '';

	$mapsDefaultSettings['egMapsResizableByDefault'] = false;

	$mapsDefaultSettings['egMapsRezoomForKML'] = false;
...
// Mapping service specific configuration
	...
	// Google Maps v3
		...
		$mapsDefaultSettings['egMapsGMaps3Type'] = 'roadmap';

		// Array. List of controls to display onto maps by default.
		$mapsDefaultSettings['egMapsGMaps3Controls'] = [
			'pan',
			'zoom',
			'type',
			'scale',
		...
		$mapsDefaultSettings['egMapsGMaps3DefTypeStyle'] = 'default';

		// String. The default style for the zoom control.
		// small, large or default
		$mapsDefaultSettings['egMapsGMaps3DefZoomStyle'] = 'default';

		// Boolean. Open the info windows on load by default?
		$mapsDefaultSettings['egMapsGMaps3AutoInfoWindows'] = false;

		// Array. Layers to load by default.
		// traffic and bicycling
		$mapsDefaultSettings['egMapsGMaps3Layers'] = [];

		// Integer. Default tilt when using Google Maps.
		$mapsDefaultSettings['egMapsGMaps3DefaultTilt'] = 0;

		// Show points of interest or not.
		$mapsDefaultSettings['egMapsShowPOI'] = true;

		// String. Set the language when rendering Google Maps.
		$mapsDefaultSettings['egMapsGMaps3Language'] = '';

	// OpenLayers

		// Integer. The default zoom of a map. This value will only be used when the
		// user does not provide one.
		$mapsDefaultSettings['egMapsOpenLayersZoom'] = 13;
		...
		$mapsDefaultSettings['egMapsOLControls'] = [
			'layerswitcher',
			'mouseposition',
			'autopanzoom',
			'scaleline',
		...
		$mapsDefaultSettings['egMapsOLLayers'] = [
			'osm-mapnik',
			'osm-cyclemap'
		];

		// The definitions for the layers that should be available for the user.
		$mapsDefaultSettings['egMapsOLAvailableLayers'] = [
		...
		// must only contain layers that are present in $mapsDefaultSettings['egMapsOLAvailableLayers'].
		$mapsDefaultSettings['egMapsOLLayerGroups'] = [
		...
		// Layer dependencies
		$mapsDefaultSettings['egMapsOLLayerDependencies'] = [
	...
	// Leaflet
		...
		// Integer. The default zoom of a map. This value will only be used when the
		// user does not provide one.
		$mapsDefaultSettings['egMapsLeafletZoom'] = 14;

		// String. The default layer for Leaflet. This value will only be
		// used when the user does not provide one.
		$mapsDefaultSettings['egMapsLeafletLayer'] = 'OpenStreetMap';

		$mapsDefaultSettings['egMapsLeafletLayers'] = [ $mapsDefaultSettings['egMapsLeafletLayer'] ];

		$mapsDefaultSettings['egMapsLeafletOverlayLayers'] = [

		];

		// The definitions for the layers that should be available for the user.
		$mapsDefaultSettings['egMapsLeafletAvailableLayers'] = [
			'OpenStreetMap' => true,
		...
		$mapsDefaultSettings['egMapsLeafletAvailableOverlayLayers'] = [
		...
		$mapsDefaultSettings['egMapsLeafletLayersApiKeys'] = [
			'MapBox' => '',
			'MapQuestOpen' => '',
		];

		// Layer dependencies
		$mapsDefaultSettings['egMapsLeafletLayerDependencies'] = [
			'MapQuestOpen' => 'https://open.mapquestapi.com/sdk/leaflet/v2.2/mq-map.js?key=',
		];


	$mapsDefaultSettings['egMapsGlobalJSVars'] = [];

return $mapsDefaultSettings;
